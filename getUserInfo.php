...
$query = "SELECT * FROM user WHERE id=". $userID; //store sql statement to pass in the msqi quessy function
...
//echo $row["name"] . "<br />"; //output username
//echo $row["id"];		//output user id
